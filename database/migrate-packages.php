<?php
// Database migration script for packages table
...
try {
    ...
    echo "Starting packages table migration...\n";
    ...
    $checkData = $db->query("SELECT COUNT(*) FROM packages")->fetchColumn();
    ...
    if ($checkData == 0) {
        ...
        echo "✓ Packages table already contains data (" . $checkData . " records)\n";
    }
    
    echo "\n=== MIGRATION COMPLETED SUCCESSFULLY ===\n";
    echo "You can now use the packages management in your admin dashboard!\n";
