<?php
// Reset packages table migration script
...
try {
    ...
    echo "Resetting packages table...\n";
    
    // Drop existing packages table
    $db->exec("DROP TABLE IF EXISTS packages");
    echo "✓ Old packages table dropped\n";
    
    // Create new packages table with correct structure
    $createTableSQL = "
    ...
    echo "✓ New packages table created successfully\n";
    
    // Insert sample packages data
    echo "Inserting sample packages data...\n";
    ...
    $db->exec($insertSQL);
    echo "✓ Sample packages data inserted successfully\n";
    
    echo "\n=== PACKAGES TABLE RESET COMPLETED ===\n";
    echo "The packages table now has the correct structure for the admin dashboard!\n";
