...
try {
    // Try both possible database names (booking_engine is primary)
    $databases = ['booking_engine', 'spa_booking'];
...
private $db_name = "booking_engine"; // Primary database name
...
- [ ] **Database Exists**: booking_engine (primary) or spa_booking (legacy)  
