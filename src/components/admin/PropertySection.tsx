          ...
          {!isEditing ? (
            ...
            <>
              ...
              <button 
                onClick={handleSave}
                disabled={saving}
                className="bg-hotel-sage text-white px-4 py-2 rounded-md hover:bg-hotel-sage/90 disabled:opacity-50 flex items-center gap-2"
              >
                {saving ? (
                  <>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex justify-between items-center mb-4">
              ...
              {isEditing && (
                <button
                  onClick={addImage}
                  className="bg-hotel-navy text-white px-3 py-1 rounded text-sm hover:bg-hotel-navy/90 flex items-center gap-1"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {isEditing ? (
                    <>
                      ...
                      <button
                        ...
                        className="bg-hotel-bronze text-white px-2 py-2 rounded text-sm hover:bg-hotel-bronze/90"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
